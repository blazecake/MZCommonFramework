...
import com.melon.network.NetworkUtil;
...
public class CustomHttpResponse {
	...
	public static synchronized HttpResponse getHttpResponse(final Context context, HttpClient httpClient, HttpRequestBase request, Long requestTimeStamp){
		HttpResponse httpResponse =null;
