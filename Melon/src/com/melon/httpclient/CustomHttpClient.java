...
public class CustomHttpClient {
	 ...
	 * @serialData timeout 连接池超时时间:1000
	 * @serialData connectionTimeout 连接超时时间:5000
	 * @serialData soTimeout socket超时时间:10000
	 * @serialData httpPort http请求默认端口:无
	 * @serialData httpsPort https请求默认端口:无
	 * @return httpClient
	 */
	...
	/**
	 * 获得HttpClient单实例
	 * @param version 协议版本:HttpVersion.HTTP_0_9 / HttpVersion.HTTP_1_0 / HttpVersion.HTTP_1_1
