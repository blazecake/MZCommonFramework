 ...
 * <ul>
 * 注:
 * <li>未设isSerializeNulls参数时,默认不会将null值字段转换成json;</li> 
 * <li>未设datePattern参数是,默认日期模式为'yyyy-MM-dd HH:mm:ss SSS';</li> 
 * <li>未设excludesFieldsWithoutExpose参数时,默认不会将未标注 {@literal @Expose}的字段转换成json</li> 
 * </ul>
 * </strong>
 * @author maozhou
 * @date 2013-10-15 下午4:41:26
 */
